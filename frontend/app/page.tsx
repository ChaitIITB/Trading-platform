        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 min-h-[600px]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 border-r border-gray-200">
              <h2 className="text-xl font-semibold text-purple-700 mb-4">Column 1</h2>
              <p className="text-gray-600">Content for the first column goes here.</p>
            </div>

            {/* Column 2 */}
            <div className="p-6 border-r border-gray-200">
              <h2 className="text-xl font-semibold text-purple-700 mb-4">Column 2</h2>
              <p className="text-gray-600">Content for the second column goes here.</p>
            </div>

            {/* Column 3 */}
            <div className="p-6">
              <h2 className="text-xl font-semibold text-purple-700 mb-4">Column 3</h2>
